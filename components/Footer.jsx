        ...
        <div className="  bg-black">
              <div style={{borderBottom:'1px solid white'}} >
                <Row className="mb-3">
                    ...
                    <span className="text-white mt-1 fs-3 font-semibold">Hoo</span>
                    <span className="text-teal-500 mt-1 fs-3">Bank</span>
                    </div>
                    <p className="ml-16 mt-3 text-slate-500"> 
                    ...
                    <Col lg={3}>
                        ...
                        <div className="flex flex-col p-1 text-slate-500">
                        <span >Content</span>
                    ...
                    <div className="mt-4 ml-36">
                        ...
                        <span >Help Center</span>
                         ...
                         <span className='mt-1'>Suggestions</span>
                    ...
                    <div className="mt-4 ml-36">
                        ...
                        <span className="text-slate-500" >Our Partner</span>
                         <span className='mt-1 text-slate-500'>Become a Partner</span>
