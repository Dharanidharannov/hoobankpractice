...
<div className=' position-relative'>
        <Row>
          <Col lg={6} xs={12} className=' h-[65vh]'>
            <Image src="/Group 481722.png" width={300} height={100} className='ml-20 md:ml-36 mt-20 ' />
            <Image src="/Group 481710.png" width={200} height={100} className='ml-36 mt-20 position-absolute -top-20 left-52' />

            <div className='flex bg-white w-[310px] p-1 text-black rounded h-10 position-absolute top-72 mt-4 left-80'>
